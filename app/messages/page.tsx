...
export default function MessagesPage() {
    ...
    // استایل‌های مشترک دکمه‌های آیکون
    const iconBtnClass = "flex items-center justify-center rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500/20";
    const ghostBtnClass = `${iconBtnClass} text-slate-400 hover:text-slate-600 hover:bg-slate-100`;

    return (
        <div className="bg-white rounded-3xl border border-slate-200 shadow-sm h-full flex overflow-hidden font-sans">
                ...
                <div className="p-4 border-b border-slate-100">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full h-10 pr-9 pl-3 rounded-xl border border-slate-200 bg-white text-sm focus:outline-none focus:border-purple-300 focus:ring-4 focus:ring-purple-500/10 transition-all placeholder:text-slate-400"
                        />
                    </div>
                </div>
            ...
            <div className="flex-1 flex flex-col bg-white relative hidden md:flex">
                ...
                <div className="h-16 px-6 border-b border-slate-100 flex items-center justify-between bg-white/80 backdrop-blur-sm sticky top-0 z-10">
                    ...
                    <div className="flex items-center gap-1">
                        <button className={`${ghostBtnClass} w-10 h-10`}><Phone className="w-5 h-5" /></button>
                        <button className={`${ghostBtnClass} w-10 h-10`}><Video className="w-5 h-5" /></button>
                        <button className={`${ghostBtnClass} w-10 h-10`}><MoreVertical className="w-5 h-5" /></button>
                    </div>
                </div>
                ...
                <div className="p-4 border-t border-slate-100 bg-white">
                    <div className="flex items-end gap-2 bg-slate-50 p-2 rounded-2xl border border-slate-200 focus-within:border-purple-300 focus-within:ring-4 focus-within:ring-purple-500/10 transition-all">
                        <button className={`${ghostBtnClass} h-10 w-10 shrink-0`}>
                        ...
                        <div className="flex items-center gap-1 pb-1">
                            <button className={`${ghostBtnClass} h-9 w-9`}>
                                <Smile className="w-5 h-5" />
                            </button>
                            <button className={`${iconBtnClass} h-10 w-10 bg-purple-600 hover:bg-purple-700 text-white shrink-0 shadow-lg shadow-purple-200 active:scale-95`}>
