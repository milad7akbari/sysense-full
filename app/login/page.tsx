                        ...
                        {step === "PHONE" ? (
                            <div className="space-y-2 group">
                                ...
                                <Input
                                    ...
                                    className="h-12 text-left text-lg dir-ltr placeholder:text-right font-mono transition-all focus:ring-2 focus:ring-purple-500/20"
                                    dir="ltr"
                                    type="tel"
                                    autoComplete="tel"
                                    autoFocus
                            ...
                            <div className="space-y-4 animate-in fade-in zoom-in-95 duration-300">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        name="otp"
                                        placeholder="- - - - -"
                                        className="h-14 text-center tracking-[0.75em] text-3xl font-bold bg-muted/30 border-2 focus:border-purple-500 rounded-xl font-mono"
